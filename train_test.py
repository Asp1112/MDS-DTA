"""train_test.py - clean training-side harness for the MDSDTA family.
...
Examples:
  python train_test.py --model MDS_dta
  python train_test.py --model MDS_dta_both_1dcnn
  python train_test.py --model MDS_dta_protein_transformer
"""
