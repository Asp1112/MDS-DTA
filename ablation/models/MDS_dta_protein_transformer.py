...
class ProteinSimpleTransformerEncoder(nn.Module):
    def __init__(self, vocab_size, embed_dim, proj_dim, heads, dropout, padding_idx):
        super().__init__()
...
class MDSDTA_prot_transformer(nn.Module):
    def __init__(self,
                 protein_vocab=27,
